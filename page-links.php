        ...
        <div class="material-post_container">
            <div class="material-post mdl-grid">
                ...
                <div class="mdl-card mdl-shadow--4dp mdl-cell mdl-cell--12-col">
                    <div class="post_thumbnail-custom mdl-card__media mdl-color-textpage-links.1--grey-50" style="background-image: url(<?php echo showThumbnail($this); ?>);">
                    ...
                    <?php
                        function pars_callback($matches) {
                            if (class_exists("Links_Plugin")) {
                                ...
                                ', 0, $sort);
                                return '<div class="md-links">'.$r.'</div>';
                            } else {
                                return "";
                            }
                        }
                        function replace_friend_links($text) {
                            return preg_replace_callback("/<flinks\s*>\s*(.*?)\s*<\/flinks>/is", "pars_callback", $text);
                        }
                    ?>
                    <?php     
